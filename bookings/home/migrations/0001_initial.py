# Generated by Django 4.2.4 on 2023-09-20 02:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_type', models.CharField(choices=[('pre paid', 'post paid'), ('pre paid', 'post paid')], max_length=100)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hotel_booking', to='home.hotel')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_bool', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
